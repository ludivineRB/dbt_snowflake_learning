# Formation Linux : De Zéro à Expert pour Data Engineers

Linux est le système d'exploitation qui fait tourner le cloud, les serveurs de données et les pipelines Big Data (Spark, Kafka, Kubernetes). Maîtriser Linux n'est pas une option pour un Data Engineer, c'est une nécessité.
